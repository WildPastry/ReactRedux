  ...
  return (
    <section aria-label="Gallery Filter Section" className="filterWrapSection">
      <div className={"filterWrap flex pad"}>
        ...
        <FilterButton
          projectFilter={ProjectFilter.ShowBranding}
          text={"Branding"}
        />
        <FilterButton
          projectFilter={ProjectFilter.ShowGraphic}
          text={"Graphic"}
        />
        <FilterButton
          projectFilter={ProjectFilter.ShowMarketing}
          text={"Marketing"}
        />
        <FilterButton
          projectFilter={ProjectFilter.ShowWebsites}
          text={"Websites"}
        />
      </div>
    </section>
